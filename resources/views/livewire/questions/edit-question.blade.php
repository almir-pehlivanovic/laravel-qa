<x-jet-form-section submit="editQuestion">
    <x-slot name="title">
        {{ __('Edit Question') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="title" value="{{ $question->title }}" type="text" class="mt-1 block w-full" wire:model.defer="title" autocomplete="title" />
    ...
    <x-slot name="actions">
        <x-jet-action-message class="mr-3" on="saved">
            {{ __('Your question has been updated.') }}
